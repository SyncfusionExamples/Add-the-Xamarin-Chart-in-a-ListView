# Load-Chat-ListView
This example explains how to load Chat inside a ListView. SfChart provides support to add chart in ListView control. You can add the chart in ListView with the help of ItemTemplate, by using the DataTemplate for the customized ViewCell.
